                ...
                <div className="flex items-center justify-between mb-16">
                    ...
                    <div className="flex gap-4">
                        <Button 
                            variant="outline" 
                            size="icon" 
                            className="rounded-none border-slate-200 dark:border-slate-800 dark:bg-transparent dark:text-white hover:scale-110 transition-transform"
                            onClick={handleShare}
                        >
